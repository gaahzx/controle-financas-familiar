      ...
      >
        ...
        <div className="p-4 border-t border-border">
          <button
            ...
            className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-text-secondary hover:text-danger hover:bg-danger/10 transition-colors w-full"
          >
